...
class MarsRoverClientTests: XCTestCase {
    ...
    func testFetchMarsRover() {
        ...
        let expectation = self.expectation(description: "Rover should not be nil")
    ...
    func testFetchPhotos() {
        ...
        let myRover = (try! MarsPhotoReference.jsonDecoder.decode([String: MarsRover].self, from: validRoverJSON))["photo_manifest"]!
        
        marsRoverClient.fetchPhotos(from: myRover, onSol: 1) { (photos, error) in
            XCTAssertNil(error)
